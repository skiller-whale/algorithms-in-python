# Skiller Whale, Exercises for Algorithms in Python
...
2. Clone this repository onto your computer. You can do this in a terminal by using:
    ```sh
    git clone https://github.com/skiller-whale/algorithms-in-python.git
    ```

3. In a terminal, navigate to the `algorithms-in-python` directory you cloned.
...
6. At the end of the session terminate the sync script with `Ctrl + C`.
